        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer create-footer">
                    <button type="button" class="manager-btn-close btn btn-warning btn-outline-danger" data-bs-dismiss="modal">
                        @lang('site.close')
                    </button>
                    <button type="submit" class="manager-btn-add btn btn-warning btn-outline-danger">
                        @include('manager_dashboard.shortcuts.loading',['buttonName' => __('site.add')])
                    </button>
                </div>
            </div>
        </div>
